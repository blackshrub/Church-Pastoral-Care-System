  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4">{birthdaysToday.length + financialAidDue.length + atRiskMembers.length + disconnectedMembers.length} {t('tasks_need_attention')}</p>
      </div>
