...
export function VStack({ space, style, className, children, ...props }: Props) {
  ...
  if (className) {
    ...
    if (className.includes('ml-2')) classStyles.marginLeft = 8;
    if (className.includes('mb-6')) classStyles.marginBottom = 24;
  }
