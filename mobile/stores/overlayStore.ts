...
// =============================================================================
// FAITHTRACKER-SPECIFIC PAYLOADS
// =============================================================================

import type { EventType, GriefRelationship, AidType } from '@/constants/api';

/** Create care event payload */
export interface CreateCareEventPayload {
  memberId?: string;
  memberName?: string;
  campusId: string;
  /** Pre-select event type (used by quick add buttons) */
  initialEventType?: EventType;
  onSuccess?: () => void;
}

/** Event type selector payload */
export interface EventTypeSelectorPayload {
  onSelect: (eventType: EventType) => void;
}

/** Grief relationship selector payload */
export interface GriefRelationshipPayload {
  onSelect: (relationship: GriefRelationship) => void;
}

/** Aid type selector payload */
export interface AidTypePayload {
